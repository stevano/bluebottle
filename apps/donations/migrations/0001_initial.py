...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('donations_donation', (
            ...
            ('amount', self.gf('apps.bluebottle_utils.fields.MoneyField')(max_digits=9, decimal_places=2)),
        ...
        # Adding model 'DonationLine'
        db.create_table('donations_donationline', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('donation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['donations.Donation'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project'])),
            ('amount', self.gf('apps.bluebottle_utils.fields.MoneyField')(max_digits=9, decimal_places=2)),
        ))
        db.send_create_signal('donations', ['DonationLine'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'DonationLine'
        db.delete_table('donations_donationline')
    ...
    models = {
        ...
        'donations.donation': {
            ...
            'amount': ('apps.bluebottle_utils.fields.MoneyField', [], {'max_digits': '9', 'decimal_places': '2'}),
        ...
        'donations.donationline': {
            'Meta': {'object_name': 'DonationLine'},
            'amount': ('apps.bluebottle_utils.fields.MoneyField', [], {'max_digits': '9', 'decimal_places': '2'}),
            'donation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['donations.Donation']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
